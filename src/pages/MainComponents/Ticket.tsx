...
const Ticket: FC<{ ticket: any }> = ({ ticket }) => {
  ...
  const seatNumber = parseInt(ticket.seatNumber)||1;
  const price = ethers.utils.formatEther(ticket.ticketPrice)||0.1;
    ...
    >
      <div className="flex h-[300px] w-[200px] flex-col justify-between ">
        ...
        <div className="flex h-1/3 w-full justify-center p-10">
          <div className="text-2xl text-black">RCB vs MI</div>
        </div>
